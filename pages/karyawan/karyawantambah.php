    ...
    <div class="col">
        ...
        ?>
                <div class="alert alert-danger" role="alert">
                    ...
                    Nama Induk Karyawan (NIK) sama sudah ada
                </div>
                <?php
            } else {
    ...
    <div class="col">
        <div class="card px-3 py-3">
            <form action="" method="post">
                ...
                <div class="mb3 mt-3">
                    <input class="form-check-input" type="radio" name="status_karyawan" id="TETAP" required>
                    <label class="form-check-label" for="TETAP">
                        TETAP
                    </label>
                </div>
                <div class="mb3 mt-3">
                    <input class="form-check-input" type="radio" name="status_karyawan" id="KONTRAK" required>
                    <label class="form-check-label" for="KONTRAK">
                        KONTRAK
                    </label>
                </div>
                <div class="mb3 mt-3">
                    <input class="form-check-input" type="radio" name="status_karyawan" id="MAGANG" required>
